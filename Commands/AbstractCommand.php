...
// この基本コマンドクラスの主な仕事は、シェルを通じて渡されたすべての引数を解析し、
// コマンドが定義するすべての引数と値のペアのハッシュマップを設定すること
abstract class AbstractCommand implements Command
{
  ...
  */
  ...
  // この関数の目的は、クラスのエイリアスを取得することですが、エイリアスが設定されていない場合は、クラス名を返すようになっています
